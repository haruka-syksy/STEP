...
void read_pages(std::unordered_map<std::string, std::string>& pages){
  //pages.txtを読み込む関数
...
void read_links(std::unordered_map<std::string, std::set<std::string> >& links){
  //links.txtを読み込む関数
...
std::string find_page(std::unordered_map<std::string, std::string>& pages, std::string pagename){
...
std::list<std::string> bfs_make_path(
  ...
  std::unordered_map<std::string, std::set<std::string> >& links){
  ...
  std::unordered_map<std::string, std::list<std::string> > path; //start_keyから辿ったページの名前を保存
